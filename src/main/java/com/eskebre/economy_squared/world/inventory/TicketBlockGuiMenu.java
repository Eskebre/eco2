...
public class TicketBlockGuiMenu extends AbstractContainerMenu implements Eco2ModMenus.MenuAccessor {
	...
	public TicketBlockGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(Eco2ModMenus.TICKET_BLOCK_GUI.get(), id);
