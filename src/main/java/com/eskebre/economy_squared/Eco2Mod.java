package com.eskebre.economy_squared;
...
import com.eskebre.economy_squared.init.Eco2ModTabs;
import com.eskebre.economy_squared.init.Eco2ModMenus;
import com.eskebre.economy_squared.init.Eco2ModItems;
import com.eskebre.economy_squared.init.Eco2ModBlocks;
import com.eskebre.economy_squared.init.Eco2ModBlockEntities;

@Mod("eco2")
public class Eco2Mod {
	public static final Logger LOGGER = LogManager.getLogger(Eco2Mod.class);
	public static final String MODID = "eco2";

	public Eco2Mod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		Eco2ModBlocks.REGISTRY.register(modEventBus);
		Eco2ModBlockEntities.REGISTRY.register(modEventBus);
		Eco2ModItems.REGISTRY.register(modEventBus);
		Eco2ModTabs.REGISTRY.register(modEventBus);
		Eco2ModVariables.ATTACHMENT_TYPES.register(modEventBus);
		Eco2ModMenus.REGISTRY.register(modEventBus);
