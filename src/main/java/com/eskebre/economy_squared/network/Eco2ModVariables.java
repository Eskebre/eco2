...
@EventBusSubscriber
public class Eco2ModVariables {
	public static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.ATTACHMENT_TYPES, Eco2Mod.MODID);
	...
	public static void init(FMLCommonSetupEvent event) {
		Eco2Mod.addNetworkMessage(PlayerVariablesSyncMessage.TYPE, PlayerVariablesSyncMessage.STREAM_CODEC, PlayerVariablesSyncMessage::handleData);
	}
	...
	public static class PlayerVariables implements ValueIOSerializable {
		...
		public void serialize(ValueOutput output) {
			output.putDouble("currency", currency);
		}

		@Override
		public void deserialize(ValueInput input) {
			currency = input.getDoubleOr("currency", 0);
		}
	...
	public record PlayerVariablesSyncMessage(PlayerVariables data) implements CustomPacketPayload {
		public static final Type<PlayerVariablesSyncMessage> TYPE = new Type<>(Identifier.fromNamespaceAndPath(Eco2Mod.MODID, "player_variables_sync"));
